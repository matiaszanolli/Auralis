...
> **📜 Historical snapshot (Dec 2025 launch plan)**: This was the kickoff command for the Dec-2025 frontend-redesign sprint. Its 1.2.0/March-2026 target has since shipped and been surpassed (current source: unreleased 1.5.1 recovery milestone, `auralis/version.py`). The `FRONTEND_REDESIGN_ROADMAP_2_0.md` spec referenced throughout was removed in a 2025-12-27 docs cleanup (`866b7dae`) and is no longer in the repo. Kept for historical reference; use the root README for the current recovery workflow.
