...
**Supersedes**: *docs/archive/guides/RUST_DSP_HPSS_IMPLEMENTATION_SUMMARY.md* (gitignored, no longer tracked), `RUST_DSP_PROJECT_STATUS.md`, `RUST_DSP_EXTRACTION_PLAN.md`
