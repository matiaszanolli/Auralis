...
# #4919: read_wav_frame_info (WAV header parsing for #3872's per-chunk framing
# metadata) and get_wav_chunk (a thin encode_to_wav wrapper) had zero callers
# anywhere in the tree — #3872 itself was removed and nothing else adopted
# them. Deleted rather than kept as unreachable API surface.
