/**
 * Enhancement Pane V2 - Public API
 *
 * Exports all components from the enhancement-pane-v2 module.
 * Main export is EnhancementPaneV2, with named exports for sub-components.
 */
