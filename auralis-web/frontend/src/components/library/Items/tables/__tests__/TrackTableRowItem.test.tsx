/**
 * TrackTableRowItem Tests (issue #3931)
 *
 * Sibling of ArtistTrackRow.test.tsx: verifies keyboard accessibility for
 * the album-detail table row — focusable, has an aria-label describing the
 * play action, and Enter/Space trigger the same onTrackClick callback as a
 * mouse click.
 */
