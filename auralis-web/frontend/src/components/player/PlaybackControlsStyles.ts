...
const styles = {
  ...
  primaryButton: {
    ...
    boxShadow: `0 8px 24px ${tokens.colors.opacityScale.accent.strong}, 0 0 0 1px ${tokens.colors.opacityScale.white.subtle}`,
    outline: 'none',
    ...
    '&:hover:not(:disabled)': {
      ...
      boxShadow: `0 12px 32px ${tokens.colors.opacityScale.accent.veryStrong}, 0 0 0 1px ${tokens.colors.opacityScale.white.lighter}`,
    },

    '&:active:not(:disabled)': {
      transform: 'scale(0.98)',                           // Press feedback
      boxShadow: `0 4px 16px ${tokens.colors.opacityScale.accent.intense}, 0 0 0 1px ${tokens.colors.opacityScale.white.lighter}`,
    },
